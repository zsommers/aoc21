...
func TestA(t *testing.T) {
	assert.Equal(t, 40, A(input))
}

func TestB(t *testing.T) {
	assert.Equal(t, 315, B(input))
}
...
func Test_visit(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(fmt.Sprintf("%v", tt.p), func(t *testing.T) {
			require.NotPanics(t, func() { visit(tt.p, tt.g, tt.unvisited) })
			assert.Equal(t, tt.want, tt.unvisited)
		})
	}
}

func Test_lowest(t *testing.T) {
	tests := []struct {
		name  string
		m     map[point]int
		wantP point
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var p point
			var i int
			require.NotPanics(t, func() { p, i = lowest(tt.m) })
...
func Test_embiggen(t *testing.T) {
	want := [][]int{
	...
	assert.Equal(t, want, embiggen(readInput(input)))
}
